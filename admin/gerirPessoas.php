...
$table->setTitle("Gerir Pessoas");

//select the table in the datebase
$table->prepareTable("Pessoas");
//list of fields for list, new, edit and import records
//SELECT `Nome`, `Processo`, `Email`, `Telemovel`, `Tipo`, `Imagem`, `Administrador` FROM `Pessoas` WHERE 1
$table->setFieldsAtive("id, Processo, Nome, Email, Telemovel, Tipo, Imagem, Administrador",'list');
$table->setFieldsAtive("Processo, Nome, Email, Telemovel, Tipo, Imagem, Administrador", 'new');
$table->setFieldsAtive("Processo, Nome, Email, Telemovel, Tipo, Imagem, Administrador", 'edit');
$table->setFieldsAtive("Processo, Nome, Email, Telemovel, Tipo, Imagem, Administrador", 'csv');
