...
$table->setTitle("Gerir Lista de Horas");

//select the table in the datebase
$table->prepareTable("ListadeHoras");
//SELECT `Tempo`, `Periodo` FROM `ListadeHoras` WHERE 1
//list of fields for list, new, edit and import records
$table->setFieldsAtive("id, Tempo, Periodo");
$table->setFieldsAtive("Tempo, Periodo", 'new');
$table->setFieldsAtive("Tempo, Periodo", 'edit');
$table->setFieldsAtive("Tempo, Periodo", 'csv');
