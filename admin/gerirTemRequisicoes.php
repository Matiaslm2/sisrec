...
$table->setTitle("Tempo de Requisição");

//select the table in the datebase
$table->prepareTable("TempoDeRequisicao");
//SELECT `IdRecursos`, `Tempo`, `NumRequisicao`, `IdTempoRequisicao` FROM `TempoDeRequisicao` WHERE 1
//list of fields for list, new, edit and import records
$table->setFieldsAtive("id, IdRecursos, Tempo, NumRequisicao, IdTempoRequisicao",'list');
$table->setFieldsAtive("IdRecursos, Tempo, NumRequisicao, IdTempoRequisicao", 'new');
$table->setFieldsAtive("IdRecursos, Tempo, NumRequisicao, IdTempoRequisicao", 'edit');
$table->setFieldsAtive("IdRecursos, Tempo, NumRequisicao, IdTempoRequisicao", 'csv');
