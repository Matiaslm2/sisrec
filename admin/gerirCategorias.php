...
$table->setTitle("Lista de Categorias");

//select the table in the datebase
$table->prepareTable("paginas");
//SELECT `id`, `categorias` FROM `paginas` WHERE 1
//list of fields for list, new, edit and import records
$table->setFieldsAtive("id, categorias",'list');
$table->setFieldsAtive("categorias", 'new');
$table->setFieldsAtive("categorias", 'edit');
$table->setFieldsAtive("categorias", 'csv');
