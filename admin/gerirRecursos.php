...
$table->prepareTable("Recursos");
//SELECT `IdRecursos`, `Nome`, `IdCategoria` FROM `Recursos` WHERE 1
//list of fields for list, new, edit and import records
$table->setFieldsAtive("id, IdRecursos, Nome, IdCategoria",'list');
$table->setFieldsAtive("IdRecursos, Nome, IdCategoria", 'new');
$table->setFieldsAtive("IdRecursos, Nome, IdCategoria", 'edit');
$table->setFieldsAtive("IdRecursos, Nome, IdCategoria", 'csv');
