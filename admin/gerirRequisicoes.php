...
$table->setTitle("Requisições");

//select the table in the datebase
$table->prepareTable("Requisicao");
//SELECT `NumRequisicao`, `Data`, `Estado`, `Processo` FROM `Requisicao` WHERE 1
//list of fields for list, new, edit and import records
$table->setFieldsAtive("id, NumRequisicao, Data, Estado, Processo",'list');
$table->setFieldsAtive("NumRequisicao, Data, Estado, Processo", 'new');
$table->setFieldsAtive("NumRequisicao, Data, Estado, Processo", 'edit');
$table->setFieldsAtive("NumRequisicao, Data, Estado, Processo", 'csv');
